...
namespace Forms
{
    public partial class FrmTahminiButce : Form
    {
        ...
        public FrmTahminiButce(int seciliKoyIndex, byte seciliDonemIndex)
        {
            ...
            // PictureBox'ların MouseEnter ve MouseLeave olaylarını bağlayın
            AttachMouseEvents(pcBoxTahminiGelir, new Size(157, 95), new Size(136, 90));
            AttachMouseEvents(pcBoxTahminiGider, new Size(157, 95), new Size(136, 90));
            AttachMouseEvents(pcBoxIdariIsler, new Size(157, 95), new Size(136, 90));
